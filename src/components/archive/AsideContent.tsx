...
type T2Props = AsideContentProps &
  T1Props & {
    className?: string;
  };

type PProps = Omit<T2Props, 'title'>;

function AsideContent({ children }: AsideContentProps) {
  // const line =
...
function T2({ children, title, className }: T2Props) {
  return (
